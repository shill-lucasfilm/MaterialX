...
void NG_place2d_vector2(vec2 texcoord1, vec2 pivot, vec2 scale, float rotate, vec2 offset, int operationorder, out vec2 out1)
{
    ...
    else if (float(operationorder) < float(6))
    {
        N_switch_operationorder_out = vec2(0.000000, 0.000000);
    }
    else if (float(operationorder) < float(7))
    {
        N_switch_operationorder_out = vec2(0.000000, 0.000000);
    }
    else if (float(operationorder) < float(8))
    {
        N_switch_operationorder_out = vec2(0.000000, 0.000000);
    }
    else if (float(operationorder) < float(9))
    {
        N_switch_operationorder_out = vec2(0.000000, 0.000000);
    }
    else if (float(operationorder) < float(10))
    {
        N_switch_operationorder_out = vec2(0.000000, 0.000000);
    }
